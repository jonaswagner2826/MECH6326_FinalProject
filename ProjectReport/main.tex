...
For each of the potential inputs, a markov chain is then derived upon this 5D space using the transition matrices from \autoref{sec:transition_matrices}.
Within MALTAB this is computed ahead of time (and stored in P.mat) and then flattened for matrix multiplication for computational efficiency.
