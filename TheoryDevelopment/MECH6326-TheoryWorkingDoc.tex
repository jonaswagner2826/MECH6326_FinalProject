...
% The update amount for states is then $(1 \text{ or } 2) + (\text{"success" or "failure"})(\text{d4 or d6 or d8})$
...
\todo{Should this be as simple as it is or do we want to make it more general and then specify the static things?}
...
\begin{itemize}
    ...
    \item The monsters static movement: $f_{mn,m}(x_k) = (1,1)$ \todo{do we want a specific trajectory or just move each time-step? or just static?}
