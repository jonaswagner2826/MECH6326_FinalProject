...
\begin{itemize}
    ...
    \] where $\operatorname{direction}()$ is calculated as the closest cardinal direction that heads towards the player. (In matlab we do: \verb!round(normalize(x_pc_p-x_mn_p))!)
    % $f_{mn,m}(x_k) = (1,1)$ 
